...
export default function Infrastructure() {
  return (
    <div>
      ...
      <ServiceGrid title="Telecom Tower Inspections" image={MEDIA.infra_section_telecom_image} services={telecomServices} />
      <div className="border-t border-border/30" />
      <ServiceGrid title="Power Line Inspections" image={MEDIA.infra_section_powerlines_image} services={powerlineServices} />
